...
namespace Order.Infrastructure.Migrations
{
    ...
    [Migration("20260526074930_UseXminForOrderSagaConcurrency")]
    partial class UseXminForOrderSagaConcurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Order.Domain.Entities.OrderTimelineEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OrderTimelineEvents", "order");
                });

            modelBuilder.Entity("Order.Infrastructure.Saga.OrderSagaInstance", b =>
                {
                    b.Property<Guid>("CorrelationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CurrentState", "UpdatedAt")
                        .HasDatabaseName("IX_OrderSagaInstances_CurrentState_UpdatedAt");

                    b.ToTable("OrderSagaInstances", "order");
                });
