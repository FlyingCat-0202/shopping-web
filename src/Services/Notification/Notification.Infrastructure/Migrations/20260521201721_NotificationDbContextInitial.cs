...
{
    /// <inheritdoc />
    public partial class NotificationDbContextInitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recipients", x => x.CustomerId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_CustomerId_IsRead_CreatedAt",
                schema: "notification",
                table: "Notifications",
