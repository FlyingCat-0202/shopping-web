...
namespace Product.Infrastructure.Migrations
{
    ...
    [Migration("20260602104944_AddProductCatalogIndexes")]
    partial class AddProductCatalogIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Product.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("IsActive", "CategoryId", "Name", "Id")
                        .HasDatabaseName("IX_Products_Catalog_Category_Name");

                    b.HasIndex("IsActive", "CategoryId", "Price", "Id")
                        .HasDatabaseName("IX_Products_Catalog_Category_Price");

                    b.HasIndex("IsActive", "StockQuantity", "Name", "Id")
